                    ...
                    <v-container>
                        <v-form @submit.prevent="">
                            ...
                            <v-row justify="center" class="mt-6 mb-16">
                                ...
                                <v-col cols="12" lg="6" md="6">
                                    <v-text-field solo rounded label="Razón social" class="" :rules="[rules.required]"></v-text-field>
                                </v-col>

                                <v-col cols="12" lg="6" md="6">
                                    <v-text-field solo rounded label="Correo electrónico" type="email" class="" :rules="[rules.required, rules.email]"></v-text-field>
                                </v-col>
                                <v-col cols="12" lg="6" md="6">
                                    <v-text-field solo rounded label="Teléfono" class=""></v-text-field>
                                </v-col>
                                ...
                                <v-col cols="12" lg="6" md="6">
                                    <v-select solo rounded label="País" class="" :rules="[rules.required]"></v-select>
                                </v-col>
                                ...
                                <v-col cols="12" lg="6" md="6">
                                    <v-select solo rounded label="Producto de interés" class="" :rules="[rules.required]"></v-select>
                                </v-col>
                                <v-col cols="12" lg="6" md="6">
                                ...
                                <v-col cols="12" lg="6" md="6">
                                    <v-textarea solo rounded label="Cuéntanos brevemente qué deseas consultar con nosotros." class=""></v-textarea>
                                </v-col>
